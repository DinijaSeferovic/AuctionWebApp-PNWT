	...
	return (
		<div>
			...
			<div className={classes.privacytext}>
				...
				<p>
					At Auction App, accessible from www.auctionapp.com, one of
					our main priorities is the privacy of our visitors. This
					Privacy Policy document contains types of information that
					is collected and recorded by Auction App and how we use it.
				</p>
				...
				<p>
					Auction App follows a standard procedure of using log files.
				...
				<p>
					...
					each of the advertising partners of Auction App.
				</p>

				<p>
					Third-party ad servers or ad networks uses technologies like
					cookies, JavaScript, or Web Beacons that are used in their
					respective advertisements and links that appear on Auction
					App, which are sent directly to users' browser. They
				...
				<p>
					Note that Auction App has no access to or control over these
				...
				<p>
					Auction App's Privacy Policy does not apply to other
				...
				<p>
					Auction App does not knowingly collect any Personal
