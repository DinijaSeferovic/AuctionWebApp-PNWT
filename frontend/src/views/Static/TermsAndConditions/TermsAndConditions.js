		...
		<div>
			...
			<div className={classes.termstext}>
				...
				<p>
					...
					webpage shall manage your use of our website, Auction App
					accessible at www.auctionapp.com.
				</p>
				...
				<p>
					...
					have been generated with the help of the Terms And
					Conditiions Sample Generator.
				</p>
				...
				<p>
					Other than the content you own, under these Terms, Auction
					App and/or its licensors own all the intellectual property
				...
				<p>
					...
					access by you and Auction App may further restrict access by
				...
				<p>
					...
					displaying Your Content, you grant Auction App a
				...
				<p>
					...
					third-party’s rights. Auction App reserves the right to
				...
				<p>
					...
					Auction App express no representations or warranties, of any
				...
				<p>
					In no event shall Auction App, nor any of its officers,
					directors and employees, shall be held liable for anything
					arising out of or in any way connected with your use of this
					Website whether such liability is under contract.  Auction
					App, including its officers, directors and employees shall
					not be held liable for any indirect, consequential or
				...
				<p>
					You hereby indemnify to the fullest extent Auction App from
				...
				<p>
					Auction App is permitted to revise these Terms at any time
				...
				<p>
					The Auction App is allowed to assign, transfer, and
				...
				<p>
					These Terms constitute the entire agreement between Auction
					App and you in relation to your use of this Website, and
				...
				<p>
					...
					accordance with the laws of the State of ba, and you submit
					to the non-exclusive jurisdiction of the state and federal
					courts located in ba for the resolution of any disputes.
				</p>
			</div>
		</div>
	);
